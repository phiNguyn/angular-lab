...
import { ProductList } from 'src/app/type/Inventor';
...
export class Lab4Component implements OnInit {
  ...
  listProduct: ProductList[] = [
    ...
    this._listFilter="";
      ...
      this.product = this.listFilter ?
     this.performFilter(this.listFilter) : this.listProduct;
      }
      performFilter(filterBy: string): ProductList[] {
      filterBy = filterBy.toLocaleLowerCase();
      return this.listProduct.filter((product: ProductList) =>
      product.productName.toLocaleLowerCase().indexOf(filterBy) !== -1);
      }
      showImgae : boolean = true
      toggleImgae () : void{
